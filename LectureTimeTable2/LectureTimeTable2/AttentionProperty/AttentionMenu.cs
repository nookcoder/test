...
namespace LectureTimeTable2.AttentionProperty
{
    ...
    { 
        ...
        public AttentionMenu(List<StudentsVO> students, List<CourseVO> course, List<AttentionVO> attentions)
        {
            this.course = course;
        ...
        {
            int menu;
            InitialMenu InitialMenu = new InitialMenu(students, course, attentions);
