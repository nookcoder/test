...
namespace printstar
{
    class Program
    {
        class PrintIng
        {
            public void printingBigger(int line) // 가운데 별 찍기
            {
            ...
            public void printingDiamond(int line) // 다이아몬드 찍기 함수 
            {
            ...
            public void printingStar(int type, int line) // 별 출력 함수
            {
        ...
        class Ask
        {
            public int askType() // 무슨 모양으로 출력하고 싶은지 물어보는 함수 
            {
                int type;
            ...
            public int askLine() // 몇 줄 출력하고 싶은 물어보는 함수 
            {
                int line;
            ...
            public int askReplay() // 다시시작 할 것인지, 종료할 것인지 선택하는 함수 
            {
        ...
        class PrintStar
        {
            ...
            static void Main(string[] args)
            {
                ...
                while (again != 2) {
                    type = ask.askType(); 
                    line = ask.askLine(); 
                    printing.printingStar(type, line);
                    again = ask.askReplay(); 
                } 
